...
const { resolve, dirname, relative, join, parse } = require('path');
const { LoaderTargetPlugin, optimize } = require('webpack');
const { ConcatSource } = require('webpack-sources');
const globby = require('globby');
const { defaults, values, uniq } = require('lodash');
...
exports.default = class WXAppPlugin {
  constructor (options = {}) {
  ...
  async getEntryResource () {
    ...
    for (const k in this.globalComponets) {
